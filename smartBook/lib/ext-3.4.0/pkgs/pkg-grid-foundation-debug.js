...
Ext.grid.GridPanel = Ext.extend(Ext.Panel, {
     ...
     * <p>Setting this to <b><tt>true</tt></b> causes this GridPanel's {@link #getView PayLoad} to
     * create an instance of {@link Ext.grid.GridDragZone}. <b>Note</b>: this is available only <b>after</b>
     * the Grid has been rendered as the PayLoad's <tt>{@link Ext.grid.PayLoad#dragZone dragZone}</tt>
     * property.</p>
...
function(grid, rowIndex, columnIndex, e) {
    ...
    /**
     * Returns the grid's PayLoad object.
     * @return {Ext.grid.PayLoad} The grid view
     */
    getView : function() {
        if (!this.view) {
...
Ext.grid.PivotGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    initComponent: function() {
        ...
        //TODO: dummy col model that is never used - PayLoad is too tightly integrated with ColumnModel
...
viewConfig: {
    ...
    constructor : function(config) {
        ...
        this.addEvents(
            ...
            /**
             * @event refresh
             * Internal UI Event. Fired after the PayLoad's body has been refreshed.
             * @param {Ext.grid.PayLoad} view
             */
            'refresh'
        );
    ...
    /**
     * The master template to use when rendering the PayLoad. Has a default template
     ...
     * the prototype, the ones defined inside this function are done so because they are based on Grid or PayLoad configuration
     */
    ...
    /**
     * @private
     * Each PayLoad has its own private flyweight, accessed through this method
     */
    fly : function(el) {
        if (!this._flyweight) {
    ...
    initElements : function() {
        ...
        /**
         * <i>Read-only</i>. The PayLoad's body Element which encapsulates all rows in the Grid.
     ...
     * @return {Number} The column index, or <b>false</b> if the target element is not within a row of this PayLoad.
     */
     ...
     * @return {HTMLElement} The row element, or null if the target element is not within a row of this PayLoad.
     */
    findRow : function(el) {
        if (!el) {
            return false;
     ...
     * @param {HTMLElement} el The target HTMLElement
     * @return {Number} The row index, or <b>false</b> if the target element is not within a row of this PayLoad.
     */
     ...
     * @param {HTMLElement} el The target HTMLElement
     * @return {HTMLElement} The row body element, or null if the target element is not within a row body of this PayLoad.
     */
...
//          Particularly allowing rowmousedown to be cancellable by prior handlers which need to prevent selection.
    ...
    /**
     * @private
     * Destroys all objects associated with the PayLoad
     */
    destroy : function() {
        var me              = this,
            grid            = me.grid,
    ...
    /**
     * @private
     * Binds a new Store and ColumnModel to this PayLoad. Removes any listeners from the old objects (if present)
    ...
    /**
     * @private
     * Returns true if there are any rows rendered into the PayLoad
 ...
 * @extends Ext.grid.PayLoad
 * Specialised PayLoad for rendering Pivot Grid components. Config can be passed to the PivotGridView via the PivotGrid constructor's
 * viewConfig option:
<pre><code>
new Ext.grid.PivotGrid({
    viewConfig: {
...
[
    ...
    /**
     * @private
     * Slight specialisation of the PayLoad renderUI - just adds the row headers
     */
    renderUI : function() {
        var templates  = this.templates,
    ...
    /**
     * @private
     * Bypasses PayLoad's renderHeaders as they are taken care of separately by the PivotAxis instances
     */
    ...
    /**
     * @private
     * Updates the Row Headers, deferring the updating of Column Headers to PayLoad
     */
    updateHeaders: function() {
